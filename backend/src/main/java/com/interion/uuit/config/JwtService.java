...
public class JwtService {
    ...
    private static final String SECRET_KEY = "AE7F2B2685EFB401A5B4960E01FDFF23C48880B1657C3A35B0B5564979FA3024";
    ...
    private Key getSignInKey() {
        var signingKey = Decoders.BASE64.decode(SECRET_KEY);
